...
plotTrivariate(-1,-1,-1,...
    'x_name','f_{clay} [-]','y_name','f_{sand} [-]','z_name','BFI_5 [-]',...
    'ID',-1,...
...
plotTrivariate(mean_age(OregonCascades),CAMELS_signatures.BFI90(OregonCascades),CAMELS_data.frac_snow(OregonCascades),...
    'x_name','Mean age [Ma]','y_name','BFI_{90} [-]','z_name','f_{snow} [-]','ID',CAMELS_data.gauge_id(OregonCascades),...
...
plotBivariate(sinkhole_density(OzarksMissouri),CAMELS_signatures.BFI5(OzarksMissouri),...
    'x_name','# Sinkholes / km^2 ','y_name','BFI_{5} [-]','ID',CAMELS_data.gauge_id(OzarksMissouri),...
...
plotTrivariate(edwards_trinity_frac(EdwardsPlateau),CAMELS_signatures.BFI90(EdwardsPlateau),...
    ...
    'x_name','Edwards-Trinity frac. [-]','y_name','BFI_{90} [-]','z_name','Q/P [-]',...
...
% subsurface
plotBivariate(-1,-1,...
    'x_name','BFI_{5} [-]','y_name','\beta_m [-]','ID',1,...
    'show_corr',false,'show_fit',false,'show_hist',false,...
...
% subsurface
plotBivariate(-1,-1,...
    'x_name','BFI_{90} [-]','y_name','\beta_m [-]','ID',1,...
    'show_corr',false,'show_fit',false,'show_hist',false,...
    'x_limits',[0 1],'y_limits',[0 7],...
    'figure_title','(c) Subsurface','figure_name','release','save_figure',false,'figure_path',fig_path)
...
saveFig(gcf,strcat('bivariate_','BFI90_recession_subsurface'),fig_path,'-dmeta')
...
saveFig(gcf,strcat('bivariate_','BFI90_recession_lakes'),fig_path,'-dmeta')
...
saveFig(gcf,strcat('bivariate_','BFI90_recession_snow'),fig_path,'-dmeta')
...
% subsurface
plotBivariate(-1,-1,...
    'x_name','BFI_{5} [-]','y_name','BFI_{90} [-]','ID',1,...
    'show_corr',false,'show_fit',false,'show_hist',false,...
...
saveFig(gcf,strcat('bivariate_','BFI5_BFI90_subsurface'),fig_path,'-dmeta')
...
saveFig(gcf,strcat('bivariate_','BFI5_BFI90_lakes'),fig_path,'-dmeta')
...
saveFig(gcf,strcat('bivariate_','BFI5_BFI90_snow'),fig_path,'-dmeta')
...
plotMapUS(CAMELS_data.gauge_lat,CAMELS_data.gauge_lon,CAMELS_signatures.BFI5,...
    'attribute_name','BFI_5 [-]','ID',CAMELS_data.gauge_id,...
...
plotMapUS(CAMELS_data.gauge_lat,CAMELS_data.gauge_lon,CAMELS_signatures.BFI90,...
    'attribute_name','BFI_{90} [-]','ID',CAMELS_data.gauge_id,...
...
plotMapUS(CAMELS_data.gauge_lat,CAMELS_data.gauge_lon,CAMELS_signatures.recession_beta,...
    'attribute_name','\beta_m [-]','ID',CAMELS_data.gauge_id,...
...
plotBivariate(CAMELS_signatures.BFI5,CAMELS_signatures.BFI90,...
    'x_name','BFI_5 [-]','y_name','BFI_{90} [-]','ID',CAMELS_data.gauge_id,...
    'show_corr',false,'show_fit',false,'show_hist',false,...
...
plotBivariate(CAMELS_signatures.BFI5,CAMELS_signatures.recession_beta,...
    'x_name','BFI_5 [-]','y_name','\beta_m [-]','ID',CAMELS_data.gauge_id,...
    'show_corr',false,'show_fit',false,'show_hist',false,...
...
plotBivariate(CAMELS_signatures.BFI90,CAMELS_signatures.recession_beta,...
    'x_name','BFI_{90} [-]','y_name','\beta_m [-]','ID',CAMELS_data.gauge_id,...
    'show_corr',false,'show_fit',false,'show_hist',false,...
