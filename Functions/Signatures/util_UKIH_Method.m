function [B] = util_UKIH_Method(Q, varargin)
%util_UKIH_Method: Calculate baseflow UKIH method.
%   Calculate baseflow UKIH "smoothed minima" method (UK Institute of
%   Hydrology, 1980).
%
%   INPUT
%   Q: [mm/timestep]
...
% calculate baseflow
[B, t_ind] = UKIH_Method(Q_tmp, n_days); % 5 is the default parameter
...
function [B, t_ind] = UKIH_Method(Q, n_days)
...
if t_ind == 0
    ...
    B = interp1q(t_TP',TP',t_ind); % linear interpolation
    Qt = Q(t_ind);
